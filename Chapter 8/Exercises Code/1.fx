...
SamplerState samAnisotropicBorder
{
	Filter = ANISOTROPIC;
	MaxAnisotropy = 4;
...
SamplerState samAnisotropicClamp
{
	Filter = ANISOTROPIC;
	MaxAnisotropy = 4;
...
SamplerState samAnisotropicMirror
{
	Filter = ANISOTROPIC;
	MaxAnisotropy = 4;
...
float4 PS(VertexOut pin, uniform int gLightCount, uniform bool gUseTexure) : SV_Target
{
	...
	{		
		...
		//texColor = gDiffuseMap.Sample(samAnisotropicWrap, pin.Tex);
		//texColor = gDiffuseMap.Sample(samAnisotropicBorder, pin.Tex);
		//texColor = gDiffuseMap.Sample(samAnisotropicClamp, pin.Tex);
		texColor = gDiffuseMap.Sample(samAnisotropicMirror, pin.Tex);
	}
