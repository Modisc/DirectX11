...
// 
//	연습문제 6장 13
//	적절한 크기의 직사각형들의 배열을 파이프라인에 제출해서 D3D가 가위 판정(Scissor Test)
//	이라는 것을 수행하게 할 수 있다. 도형 예제를 가위 판정을 적용하도록 수정하라.
// 
// 
//***************************************************************************************
...
bool ShapesApp::Init()
{
	...
	// 직사각형의 좌상단 점과 우하단 점의 좌표 설정
	D3D11_RECT rects = { 100, 100, 400, 400 };

	// 첫번째 매개변수 : UINT타입, 바인딩 할 가위 직사각형의 개수
	// 두번째 매개변수 : const D3D11_RECT* 타입, 가위 직사각형의 배열(D3D11_RECT 참조)
