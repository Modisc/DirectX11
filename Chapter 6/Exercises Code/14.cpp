...
// 
//	연습문제 6장 14
//	GeometryGenerator::CreateSphere 대신 GeometryGenerator::CreateGeoSphere를 사용하도록
//	도형 예제를 수정하라. 세분 수준을 0, 1, 2, 3으로 바꾸어 가면서 시험해 볼 것.
// 
// 
//***************************************************************************************
...
void ShapesApp::BuildGeometryBuffers()
{
	...
	geoGen.CreateGeosphere(0.5f, 4, sphere);
