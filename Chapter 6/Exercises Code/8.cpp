...
// 
//	연습문제 6장 8번
//	상자 예제에서 상자를 와이어프레임 모드로 렌더링하라.
//	두 가지 방법이 있다.
//	1. C++ 코드에서 ID3D11DeviceContext::RSSetState 메서드를 이용해서 래스터화기 렌더 상태 설정
//	2. 효과 파일의 패스 정의에서 SetRasterizerState()를 이용해서 래스터화기 렌더 상태를 설정 ( 6.8.1절 240p 참고)
// 
// 
//***************************************************************************************
...
bool SolutionApp::Init()
{
	...
	wireFrameDesc.FrontCounterClockwise = false;	// 시계 방향이 전면
