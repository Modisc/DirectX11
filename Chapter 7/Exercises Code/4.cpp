...
// 
// 연습문제 7장 4번
// 조명 예제를, 점적광 원뿔의 각도가 사용자의 키보드 입력에 따라 증가하거나 감소하도록 수정하라.
// 
// 
//***************************************************************************************
...
void LightingApp::UpdateScene(float dt)
{
	...
	// mSpotLight.Spot 값의 범위를 어느정도 제한해두면 좀 더 안전한 프로그램이 된다.
	// 방향키 <- 버튼 누를 시 원뿔 각도 감소.
	if(GetAsyncKeyState(VK_LEFT) & 0x8000)
	{
		mSpotLight.Spot += 4.0f;
		std::cout << mSpotLight.Spot << std::endl;
	}

	// 방향키 -> 버튼 누를 시 원뿔 각도 증가.
