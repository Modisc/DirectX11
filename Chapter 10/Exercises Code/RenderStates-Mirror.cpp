...
// 10장 연습문제 11번을 위한 코드
ID3D11DepthStencilState* RenderStates::DrawShadowReflectionDSS = 0;
//
...
void RenderStates::InitAll(ID3D11Device* device)
{
	...
	D3D11_DEPTH_STENCIL_DESC drawShadowReflectionDesc;
	drawShadowReflectionDesc.DepthEnable = true;
	drawShadowReflectionDesc.DepthWriteMask = D3D11_DEPTH_WRITE_MASK_ALL;
	drawShadowReflectionDesc.DepthFunc = D3D11_COMPARISON_LESS;
	drawShadowReflectionDesc.StencilEnable = true;
	drawShadowReflectionDesc.StencilReadMask = 0xff;
	drawShadowReflectionDesc.StencilWriteMask = 0xff;
	
	drawShadowReflectionDesc.FrontFace.StencilFailOp = D3D11_STENCIL_OP_KEEP;
	drawShadowReflectionDesc.FrontFace.StencilDepthFailOp = D3D11_STENCIL_OP_KEEP;
	drawShadowReflectionDesc.FrontFace.StencilPassOp = D3D11_STENCIL_OP_INCR;
	drawShadowReflectionDesc.FrontFace.StencilFunc = D3D11_COMPARISON_EQUAL;

	drawShadowReflectionDesc.BackFace.StencilFailOp = D3D11_STENCIL_OP_KEEP;
	drawShadowReflectionDesc.BackFace.StencilDepthFailOp = D3D11_STENCIL_OP_KEEP;
	drawShadowReflectionDesc.BackFace.StencilPassOp = D3D11_STENCIL_OP_INCR;
	drawShadowReflectionDesc.BackFace.StencilFunc = D3D11_COMPARISON_EQUAL;

	HR(device->CreateDepthStencilState(&drawShadowReflectionDesc, &DrawShadowReflectionDSS));
...
void RenderStates::DestroyAll()
{
	...
	ReleaseCOM(DrawShadowReflectionDSS);
}